...
using Sample.Consumer.Device.Host.Api.Configurations;

namespace Sample.Consumer.Device.Host.Api
{
    /// <summary>
    ...
    public class Startup
    {
        ...
        /// Default policy name
        /// </summary>
        public static string CorsPolicyName => "SampleConsumerDeviceCorsPolicy";

        /// <summary>
        /// The swagger title.
        /// </summary>
        public static string SwaggerDocTitle => "Sample - Consumer Device";
