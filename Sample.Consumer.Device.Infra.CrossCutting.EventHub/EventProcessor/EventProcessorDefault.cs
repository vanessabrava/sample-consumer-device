...
using Sample.Consumer.Device.Infra.CrossCutting.Background;
using Sample.Consumer.Device.Infra.CrossCutting.EventHub.Extensions;
using Sample.Consumer.Device.Infra.CrossCutting.EventHub.Messages;
...
namespace Sample.Consumer.Device.Infra.CrossCutting.EventHub.EventProcessor
{
